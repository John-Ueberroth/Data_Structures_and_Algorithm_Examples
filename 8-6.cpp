...
int main()
{
	...
	//sort the elements in the sales array in descending order and shuffle
	//the ID numbers in the id array to keep them in parallel.
...
//identically as those of the sales array. size is the number of elements
//in each array.
//*************************************************************************
...
//as arguments. The size of these arrays is passed into num. The function
//first displays a heading, then the sorted list of product numbers and 
//sales
//************************************************************************
...
//the total units (of  all products) sold and total sales. It displaus these
//amounts.
//****************************************************************************

//This prograam uses relational operators to compare a string 
...
int main()
{
	const double PRICE_A = 249.99,
				 PRICE_B = 299.0;
	string partNum; //Holds the stereo part number 

	//Display available parts and get the users selection 
	cout << "The stereo part numbers are: \n"
		<< "Boom Box: part number S-29A\n"
		<< "Shelf Model: part number S-29A \n"
